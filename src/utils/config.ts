...
export interface HomeBannerSlideshowConfig {
  enable: boolean;
  interval: number;
  images: string[];
}
...
const typedConfig = config as {
  ...
  home_banner_slideshow: HomeBannerSlideshowConfig;
...
export const HOME_BANNER_SLIDESHOW = typedConfig.home_banner_slideshow;
